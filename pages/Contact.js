...
const Contact = () => {
  ...
  return (
    <div className="m-4 bg-slate-100 shadow-xl rounded-lg">
      <div className="flex flex-col p-20">
        <h2 className="text-3xl font-bold mt-28 mb-7">Contact</h2>
        <p className="text-black text-md mb-7">
          Please submit your inquiry using the form below and we will get in
          touch with you shortly.
        </p>
        <div className="flex gap-1.5">
          <span className="mb-4 btn bg-white text-black outline-none border-none hover:bg-slate-300 rounded-full shadow-lg">
            <a
          ...
          <from className="mx-auto">
            <div className="my-3 mx-auto">
              <input
                ...
                className="w-full mt-2 p-4 outline-none border-none rounded-lg bg-[#2B2727] text-white"
              />
            </div>
            <div className="my-3 mx-auto">
              <input
            ...
            <div className="my-3 mx-auto">
              <textarea
                className="w-full h-40 mt-2 p-4 outline-none border-none rounded-lg bg-[#2B2727] text-white"
                placeholder="Type Massage..."
              ></textarea>
            </div>
            <button
              onClick={forReload}
              className="w-full mt-2 p-3 text-lg outline-none border-none font-bold bg-[#2B2727] text-white rounded-lg tracking-wide transition-all hover:bg-[#121010] hover:text-[#bfbbbb]"
            >
              Submit
            </button>
          </from>
